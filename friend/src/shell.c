...
static u8_t dev_uuid[16] = { 0xdd, 0xde };

BT_MESH_MODEL_PUB_DEFINE(gen_onoff_pub_cli, NULL, 9/*max msg size*/ + 2/*opcode size*/);
...
static struct bt_mesh_model root_models[] = {
	...
	BT_MESH_MODEL(BT_MESH_MODEL_ID_GEN_ONOFF_CLI, NULL, &gen_onoff_pub_cli, NULL),
};
...
//HARDIK
#define OP_HELLO BT_MESH_MODEL_OP_2(0x82, 0x00)
...
static int cmd_hello(const struct shell *shell, size_t argc, char *argv[])
{
	...
	bt_mesh_model_msg_init(mod_pub->msg, OP_HELLO);
...
SHELL_STATIC_SUBCMD_SET_CREATE(mesh_cmds,
	...
	SHELL_CMD_ARG(hello, NULL, "<number>", cmd_hello, 0, 0),
